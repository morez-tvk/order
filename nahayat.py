...
class NahayatNegar:
    ...
    def multi_req(self, delay=0, time_period=5):
        ...
        pause_until = now_time.replace(hour=20, minute=delay,second=50,microsecond=985000)
...
if __name__ == '__main__':
    ...
    "cookies": {
        ...
        "oid": "31860418b51221b560bb1c732a69176b759fe1fdf72f8939",
